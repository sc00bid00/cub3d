...
/*   Updated: 2023/05/22 14:38:26 by kczichow         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	memset_window(t_display *display)
{
	...
	// ft_memset(display->img_tex->pixels, COLOR, display->img_tex->width \
	// 		* display->img_tex->height * sizeof(int32_t));
}
...
void	setup_windows(t_display *display)
{
	...
	// exit (0);
	// display->img_tex = mlx_texture_to_image(display->mlx, display->tex[NO]);
...
void	image_to_window(t_display *display)
{
	...
	// mlx_image_to_window(display->mlx, display->img_tex, 0, 0);
}
